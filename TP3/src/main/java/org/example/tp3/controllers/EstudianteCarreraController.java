...
public class EstudianteCarreraController {
    ...
    public ResponseEntity<List<CarreraConInscriptosDTO>> obtenerCarrerasConInscriptos() {
    ...
    public ResponseEntity<List<EstudianteDTO>> buscarEstudiantesPorCarreraYCiudad(
        ...
        List<EstudianteDTO> estudiantes = estudianteCarreraService.buscarEstudiantesPorCarreraYCiudad(idCarrera,
                ciudad);
